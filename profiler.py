...
WY - wyoming
    """)
    location_add = input(Fore.BLUE + "[+] add state: ")
    os.system('w3m -dump https://www.spokeo.com/'+first_name+'-'+last_name+'/'+location_add+' > output.txt')
    print(Fore.BLUE + "==================")
    print(Style.BRIGHT + Fore.CYAN + first_name)
    print(Style.BRIGHT + Fore.CYAN + last_name)
    print(Style.BRIGHT + Fore.CYAN + location_add)
    print(Fore.BLUE + "==================")
...
def add_region():
    ...
    print(Fore.BLUE + "[+] now retype the state")
    location_add = input(Fore.BLUE + "[+] add state: ")
    os.system('w3m -dump https://www.spokeo.com/'+first_name+'-'+last_name+'/'+location_add+'/'+region+' > output.txt')
    print(Fore.BLUE + "==================")
    print(Style.BRIGHT + Fore.CYAN + first_name)
    print(Style.BRIGHT + Fore.CYAN + last_name)
    print(Style.BRIGHT + Fore.CYAN + ""+location_add+"")
